import { ArrowUpRight, ArrowDownLeft, ShoppingCart, Home, Utensils, Car, Plane, Coffee, Film, Heart, Search } from "lucide-react";
...
export function TransactionsView({ selectedAccount, accountName }: TransactionsViewProps) {
    ...
    <div className="flex-1 bg-white overflow-hidden flex flex-col">
      <div className="flex-shrink-0 w-full">
        <div className="pt-6 pb-6 px-6 flex items-center justify-between gap-8">
          ...
          <div className="flex-shrink-0 w-[200px] text-right">
                  ...
                  <TableRow key={transaction.id} className="cursor-pointer">
                    <TableCell>
                      <div className={cn(
                        ...
                        transaction.type === "income" ? "bg-green-100 text-green-700" : "bg-slate-100 text-slate-700"
                      )}>
                        {transaction.icon}
                      </div>
                    </TableCell>
